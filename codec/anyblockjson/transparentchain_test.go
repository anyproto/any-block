...
func TestValidate_ContainmentIsJudgedThroughAChainOfContainers(t *testing.T) {
	for name, doc := range map[string]string{
		"a row cannot hold a paragraph behind two containers": `{"formatVersion": "2.0", "type": "page", "blocks": [
			{"type": "row"},
			{"indent": 1, "type": "group"},
			{"indent": 2, "type": "group"},
			{"indent": 3, "type": "paragraph", "text": "x"}]}`,
		"a divider holds nothing, behind any number of containers": `{"formatVersion": "2.0", "type": "page", "blocks": [
			{"type": "divider"},
			{"indent": 1, "type": "group"},
			{"indent": 2, "type": "group"},
			{"indent": 3, "type": "paragraph", "text": "x"}]}`,
...
func TestValidate_AChainOfContainersOverALegalChildIsFine(t *testing.T) {
	require.NoError(t, Validate([]byte(`{"formatVersion": "2.0", "type": "page", "blocks": [
		{"type": "row"},
		{"indent": 1, "type": "group"},
		{"indent": 2, "type": "group"},
		{"indent": 3, "type": "column"},
		{"indent": 4, "type": "paragraph", "text": "x"}]}`), Options{}),
