...
func keySlotCases() []keySlotCase {
	dv := func(inner string) string {
		return `{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview",` + inner + `}]}`
	}
	view := func(inner string) string {
		return dv(`"views":[{"id":"v1","type":"table",` + inner + `}]`)
	}
	return []keySlotCase{
		{"envelope type", `{"formatVersion":"2.0","id":"o1","type":"page"}`,
			`{"formatVersion":"2.0","id":"o1","type":""}`, "/type"},
		{"template_for",
			`{"formatVersion":"2.0","kind":"template","id":"o1","type":"template","template_for":"page"}`,
			`{"formatVersion":"2.0","kind":"template","id":"o1","type":"template","template_for":""}`,
			"/template_for"},
		{"type_properties key",
			`{"formatVersion":"2.0","kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"property":"prio","format":"text"}]}}`,
			`{"formatVersion":"2.0","kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"property":"","format":"text"}]}}`,
			"/type_settings/property_definitions/0/property"},
		{"type_properties object_types",
			`{"formatVersion":"2.0","kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"property":"who","format":"objects","object_types":["page"]}]}}`,
			`{"formatVersion":"2.0","kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"property":"who","format":"objects","object_types":[""]}]}}`,
			"/type_settings/property_definitions/0/object_types/0"},
		{"relation object_types",
			`{"formatVersion":"2.0","kind":"property","id":"o1","internal_key":"who","property_settings":{"format":"objects","object_types":["page"]}}`,
			`{"formatVersion":"2.0","kind":"property","id":"o1","internal_key":"who","property_settings":{"format":"objects","object_types":[""]}}`,
			"/property_settings/object_types/0"},
		{"properties member", `{"formatVersion":"2.0","id":"o1","properties":{"prio":"x"}}`,
			`{"formatVersion":"2.0","id":"o1","properties":{"":"x"}}`, "/properties/"},
		{"property block key",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"property","property":"prio"}]}`,
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"property","property":""}]}`,
			"/blocks/0/property"},
		{"link block properties",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"link","object_id":"t1","properties":["prio"]}]}`,
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"link","object_id":"t1","properties":[""]}]}`,
...
func TestValidate_EveryKeySlotRefusesTheEmptySpelling(t *testing.T) {
	for _, tc := range keySlotCases() {
		t.Run(tc.slot, func(t *testing.T) {
			require.NoError(t, Validate([]byte(tc.named), Options{}),
				"the control must be a document this format accepts:\n%s", tc.named)

			err := Validate([]byte(tc.empty), Options{})
...
func TestValidate_AFilterHasToNameItsProperty(t *testing.T) {
	doc := `{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[` +
...
func TestUnmarshal_EveryKeySlotRefusesAnEmptyResolution(t *testing.T) {
	// `want` is the substring the refusal has to carry. The six slots that
	...
	// vocabulary and their pointer can only be the coarse `/blocks`. The six
	// are here to state the uniformity, not because they are load-bearing —
	// reverting the change leaves them green and fails the other ten. The
	// filter case covers two slots, top-level and nested, so nine cases here
	// stand for ten slots.
	for _, tc := range []struct{ slot, doc, want string }{
		{"envelope type", `{"formatVersion":"2.0","id":"o1","type":"prio"}`,
			"/type: resolved type key is empty"},
		{"template_for",
			`{"formatVersion":"2.0","kind":"template","id":"o1","type":"template","template_for":"prio"}`,
			"/template_for: resolved type key is empty"},
		{"type_properties key",
			`{"formatVersion":"2.0","kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"property":"prio","format":"text"}]}}`,
			"/type_settings/property_definitions/0/property: resolved property key is empty"},
		{"type_properties object_types",
			`{"formatVersion":"2.0","kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"property":"who","format":"objects","object_types":["prio"]}]}}`,
			"/type_settings/property_definitions/0/object_types/0: resolved type key is empty"},
		{"relation object_types",
			`{"formatVersion":"2.0","kind":"property","id":"o1","internal_key":"who","property_settings":{"format":"objects","object_types":["prio"]}}`,
		...
		{"dataview properties key",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","properties":[{"property":"prio","format":"text"}],"views":[{"id":"v1","type":"table"}]}]}`,
			"the dataview `properties` spelling \"prio\""},
		{"view group_by",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[{"id":"v1","type":"kanban","group_by":"prio"}]}]}`,
			"the view `group_by` spelling \"prio\""},
		{"view cover_property",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[{"id":"v1","type":"gallery","cover_property":"prio"}]}]}`,
			"the view `cover_property` spelling \"prio\""},
		{"view end_property",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[{"id":"v1","type":"calendar","end_property":"prio"}]}]}`,
			"the view `end_property` spelling \"prio\""},
		{"view column property",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[{"id":"v1","type":"table","columns":[{"property":"prio"}]}]}]}`,
			"the view column `property` spelling \"prio\""},
		{"sort property",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[{"id":"v1","type":"table","sorts":[{"property":"prio","direction":"asc"}]}]}]}`,
			"the sort `property` spelling \"prio\""},
		{"filter property",
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","views":[{"id":"v1","type":"table","filters":[{"property":"prio","condition":"equal","value":"x"}]}]}]}`,
		...
		t.Run(tc.slot, func(t *testing.T) {
			...
			require.NoError(t, Validate([]byte(tc.doc), Options{}), "%s", tc.doc)
...
func TestExport_ANamelessFilterAndPropertyBlockAreDropped(t *testing.T) {
	...
	require.NoError(t, Validate(data, Options{}), "emitted:\n%s", data)
