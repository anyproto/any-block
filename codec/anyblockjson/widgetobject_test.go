...
const (
	widgetTargetA = testfixtures.ObjectID
	widgetTargetB = testfixtures.ObjectIDAlt
)
...
// WidgetsSnapshot is the builder both Heart's extraction-time converter and the round-trip
