...
func TestValidate_OnePropertySpellingAcrossTheDataview(t *testing.T) {
	for name, doc := range map[string]string{
		"properties entry": `{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","object_id":"t1",
			"properties":[{"property":"name","format":"text"}],"views":[{"id":"v"}]}]}`,
		"view column": `{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","object_id":"t1",
			"views":[{"id":"v","columns":[{"property":"name"}]}]}]}`,
		"property block": `{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"property","property":"name"}]}`,
	} {
		t.Run(name, func(t *testing.T) {
			require.NoError(t, Validate([]byte(doc), Options{}), doc)
...
func TestValidate_TheVacatedKeySpellingIsRefusedWithTheRepairNamed(t *testing.T) {
	for name, tc := range map[string]struct{ doc, path string }{
		"dataview properties entry": {
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"dataview","object_id":"t1",
				"properties":[{"key":"name","format":"text"}],"views":[{"id":"v"}]}]}`,
			"/blocks/0/properties/0/key"},
		"property block": {
			`{"formatVersion":"2.0","id":"o1","blocks":[{"id":"b1","type":"property","key":"prio"}]}`,
			"/blocks/0/key"},
