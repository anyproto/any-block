...
LISTS: every option carrying an `orderId` first, those ascending, then the
options carrying none, `createdDate` descending. Both halves are easy to
get backwards.
